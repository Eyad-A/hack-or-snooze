...
class StoryList {
  ...
  async addStory(user, newStory) {
    ...
    // create a Story instance from the response we just received
    ...
    // Delete story and update storylist 
    async removeStory(user, storyId){
      ...
      //filter the story we're removing
...
class User {
  ...
  // get user info from the API and assign the response to the current user instance
  async getUserDetails() {
    ...
    // convert user's ownStories and favorites to instances of Story 
  ...
  // Method to post or delete favorites 
